...
The keys live in `.claude/settings.json` (project) or `/Users/forumgandhi/Applications/Atoloan/atoloan-monitor/.claude/settings.json` (global) — **not** in `.planning/config.json`:
