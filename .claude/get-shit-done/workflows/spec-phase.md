...
```bash
INIT=$(node "/Users/forumgandhi/Applications/Atoloan/atoloan-monitor/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/forumgandhi/Applications/Atoloan/atoloan-monitor/.claude/get-shit-done/templates/spec.md.
