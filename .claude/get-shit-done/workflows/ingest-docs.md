...
```bash
INIT=$(node "/Users/forumgandhi/Applications/Atoloan/atoloan-monitor/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/forumgandhi/Applications/Atoloan/atoloan-monitor/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
