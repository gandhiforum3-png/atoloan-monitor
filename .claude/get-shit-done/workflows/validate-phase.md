...
```
Agent(
  prompt="Read /Users/forumgandhi/Applications/Atoloan/atoloan-monitor/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/forumgandhi/Applications/Atoloan/atoloan-monitor/.claude/get-shit-done/templates/VALIDATION.md`
